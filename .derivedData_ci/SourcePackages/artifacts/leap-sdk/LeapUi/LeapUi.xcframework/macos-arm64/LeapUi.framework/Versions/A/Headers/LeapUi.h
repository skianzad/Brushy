...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("VoiceAssistantNSViewControllerKt")))
@interface LeapUiVoiceAssistantNSViewControllerKt : LeapUiBase

/**
 * Creates an [NSViewController] hosting [VoiceAssistantWidget] for use from SwiftUI on macOS.
 *
 ...
 * import LeapUi
 *
 * struct VoiceAssistantViewRepresentable: NSViewControllerRepresentable {
 ...
 */
+ (NSViewController *)VoiceAssistantNSViewControllerState:(LeapUiVoiceAssistantStateHolder *)state onIntent:(void (^)(id<LeapUiVoiceAssistantIntent>))onIntent labels:(LeapUiVoiceWidgetLabels *)labels colors:(LeapUiVoiceWidgetColors *)colors showPoweredBy:(BOOL)showPoweredBy __attribute__((swift_name("VoiceAssistantNSViewController(state:onIntent:labels:colors:showPoweredBy:)")));
@end
