...
@interface LMDChatMessageContentFactory : LMDBase
+ (instancetype)alloc __attribute__((unavailable));
...
@property (class, readonly, getter=shared) LMDChatMessageContentFactory *shared __attribute__((swift_name("shared")));

/** Create an Image content from a UIImage. */
- (LMDChatMessageContentImage *)fromUIImageImage:(UIImage *)image __attribute__((swift_name("fromUIImage(image:)")));
...
@interface LMDChatMessageContentHelpersKt : LMDBase
 ...
 * ```
 */
+ (LMDChatMessageContent *)ChatMessageContent_fromUIImageImage:(UIImage *)image __attribute__((swift_name("ChatMessageContent_fromUIImage(image:)")));
 ...
 * ```
 */
+ (LMDChatMessageContent *)ChatMessageContent_textText:(NSString *)text __attribute__((swift_name("ChatMessageContent_text(text:)")));
 ...
 * ```
 */
+ (LMDChatMessage *)ChatMessage_withArrayRole:(LMDChatMessageRole *)role content:(NSArray<LMDChatMessageContent *> *)content __attribute__((swift_name("ChatMessage_withArray(role:content:)")));
@end
